...
export class Messages extends Component {
  ...
  searchableMessages = () => {
    let matchedMessages = this.props.messages;
  ...
  myMessagesGrouped = () => {
    return Object.entries(this.searchableMessages().reduce((acc, curr) => {
      (acc[curr['res_book']] = acc[curr['res_book']] || []).push(curr);
      return acc;
    }, {}))
    .map(m => m[1]
    .sort((a, b) => 
