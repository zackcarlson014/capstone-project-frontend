...
export class MessageItem extends Component {
  dateTime = () => {
    ...
    const minutes = this.props.messageItem[0].created_at.slice(14,16);
    ...
    const year = this.props.messageItem[0].created_at.slice(2,4);

    return `${hour}:${minutes} ${period} ${month}/${day}/${year}`;
  };
  
  receivedMessage = () => {
    return this.props.messageItem[0].recipient_id
      === this.props.authId;
  };
                  ...
                  <Grid.Column width='2'>
                    <Grid.Row>
                      {this.props.messageItem[0].read
                        ...
                        : <Header color='green' textAlign='center'>
                            new
                          </Header>
                      }
                    </Grid.Row>
