          ...
          <Grid.Row>
            ...
            <Grid.Column width='14'>
              ...
              <div className='ui eight centered cards'>
                {this.wishedBooks().slice(
                  this.bookIndex(),
                  this.bookIndex() + 8
                ).map((book, i) => {
                  if (this.libraryBooks().find(b =>
                    b[0].title === book[0].title
                    && b[0].author === book[0].author
                  )) {
                    return (
                      <DashboardWishedBookCard 
                        ...
                        user={book[1]} 
                        userBookId={book[2]} 
                        match={this.libraryBooks().find(b =>
                          b[0].id === book[0].id
                        )}
                      />
                    )
