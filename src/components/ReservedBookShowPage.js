                ...
                <div className='App'>
                    ...
                    <br/><Grid>
                        <Grid.Row>
                            ...
                            <Grid.Column width='3'><br/><br/><Button as={ Link } exact to={'/reserved_books'} color='blue'><Icon name='book'/>Reserved Books</Button></Grid.Column>
                        </Grid.Row>
                        <Grid.Row>
                            <Grid.Column width='2'></Grid.Column>
                        ...
                        {this.reservedBook().user_id === this.props.auth.id ?
                            <Grid.Row>
                                <Grid.Column width='2'></Grid.Column>
                                <Grid.Column as={ Link } exact to={`/profile`} width='2'>
