      ...
      return (
        <div>
          ...
          <Image
            ...
            exact='true'
            to={`/users/${u[1].id}`}
            src={u[1].prof_pic_url} alt=''
            size='medium'
            onClick={this.handleShowUser(u[1])}
          />
    ...
    return (
      <div style={{textAlign: 'center'}}>
        <Carousel
            ...
            duration={this.props.users.length !== 1
              ? 10000
              : null
            }
            animation='slide left'
            showNextPrev={false}
            showIndicators={this.props.users.length !== 1
              ? true
              : false
            }
        />
