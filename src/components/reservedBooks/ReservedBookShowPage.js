...
export class ReservedBookShowPage extends Component {
  ...
  componentWillMount() {
    ...
    const reqURL = `http://localhost:3000/api/v1/reserved_books/${id}`;
  ...
  addLibraryBookHistory = () => {
    ...
    const reqURL = 'http://localhost:3000/api/v1/lib_book_history_items';
  ...
  handleAddLibBook = () => {
    ...
    const reqURL = `http://localhost:3000/api/v1/user_lib_books/${libBookId}`;
            ...
            <Grid.Row>
              ...
              <Grid.Column width='4'>
                <Segment compact>
                  ...
                  <Image
                    src={this.props.book[1].id === this.props.auth.id
                      ? this.props.book[2].user.prof_pic_url
                      : this.props.book[1].prof_pic_url
                    }
                    alt=''
                    size='medium'
                  />
                  ...
                  <Button
                    as={ Link }
                    exact='true'
                    to={this.props.book[1].id === this.props.auth.id
                      ? `/users/${this.props.book[2].user.id}`
                      : `/users/${this.props.book[1].id}`
                    }
                    fluid
                    animated='fade'
                    icon='user'
                  ...
                  >
                    ...
                    <Button.Content hidden>
                        {this.props.book[1].id === this.props.auth.id
                          ? this.props.book[2].user.username
                          : this.props.book[1].username
                        }'s Profile
                    </Button.Content>
                  </Button>
                </Segment>
            ...
            {this.props.book[1].id !== this.props.auth.id
              ...
              : <Grid.Row>
                  ...
                  <Grid.Column width='2'>
                    ...
                    >
                      <Modal.Header>
                        {this.props.book[0].title} - {this.props.book[0].author}
                      </Modal.Header>
                      ...
                      <Modal.Content image>
                        ...
                        <p>
                          Have you recieved this book from
                          {this.props.book[1].id === this.props.auth.id
                            ? this.props.book[2].user.username
                            : this.props.book[1].username
                          }
            ...
            {!this.props.messages
              ...
              : <Grid.Row>
                  ...
                  <Grid.Column width='11'>
                    <Segment>
                      <ReservedMessages
                        resBookId={this.props.book[3]}
                        messages={this.props.messages}
                        user={this.props.book[1].id === this.props.auth.id
                          ? this.props.book[2].user
                          : this.props.book[1]
                        }
                      />
                    </Segment>
...
export default connect(
  ...
  {
    showReservedBook,
    removeShowReservedBook,
    updateLibBook,
    updateReservedBook,
  },
)(ReservedBookShowPage);
